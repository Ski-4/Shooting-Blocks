...
void display1(void)
{
	...
	display_string(180, 350, "Thapar Institute of Engineering and Technology", 1);
...
void disp()
{
	...
	else
	{
		...
		glColor3f(0, 1, 0);
		display_string(400, 50, "Total Score", 1);
		if (score == 0) {
			display_string(400, 30, "0", 1);
		}
		else if (score == 1) {
			display_string(400, 30, "1", 1);
		}
		else if (score == 2) {
			display_string(400, 30, "2", 1);
		}
		else if (score == 3) {
			display_string(400, 30, "3", 1);
		}
		else if (score == 4) {
			display_string(400, 30, "4", 1);
		}
		else if (score == 5) {
			display_string(400, 30, "5", 1);
		}
		else if (score == 6) {
			display_string(400, 30, "6", 1);
		}
		else if (score == 7) {
			display_string(400, 30, "7", 1);
		}
		else if (score == 8) {
			display_string(400, 30, "8", 1);
		}
		else if (score == 9) {
			display_string(400, 30, "9", 1);
		}
		else if (score == 10) {
			display_string(400, 30, "10", 1);
		}
		counting();
		// Drawing of arrow
		glColor3f(0, 1, 1);
